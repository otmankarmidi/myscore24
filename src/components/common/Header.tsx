...
export default function Header({ searchQuery = '', onSearchChange }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 left-0 right-0 z-50 bg-surface/95 backdrop-blur-md border-b border-surface-bright/40">
      <div className="max-w-[1480px] mx-auto h-14 px-4 flex items-center justify-between gap-4">
        {/* Logo */}
        <div className="flex items-center gap-3 shrink-0">
          <Link href="/" className="flex items-center gap-2">
            ...
            <div className="flex flex-col leading-none">
              <span className="font-geist font-bold text-[16px] tracking-tight text-on-surface">
                MyScore<span className="text-primary">24</span>
              </span>
              <span className="font-geist font-bold text-[9px] tracking-widest text-on-surface-variant uppercase mt-0.5">
                Scores. Stats. Live.
              </span>
            </div>
          </Link>
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          <button
            ...
            className="md:hidden w-8 h-8 rounded flex items-center justify-center bg-surface-container-low hover:bg-surface-container text-on-surface-variant hover:text-on-surface transition-colors"
            title="Search"
          ...
          <div className="relative group">
            <button
              className="w-8 h-8 rounded flex items-center justify-center bg-surface-container-low hover:bg-surface-container text-on-surface-variant hover:text-on-surface relative transition-colors"
            ...
            <div className="absolute right-0 rtl:right-auto rtl:left-0 top-9 hidden group-hover:flex flex-col bg-surface-container border border-surface-bright/50 rounded-xl shadow-2xl z-50 w-80 max-h-96 overflow-y-auto p-2 space-y-1">
              <div className="px-3 py-2 border-b border-surface-bright/50 flex items-center justify-between">
          ...
          {totalFavorites > 0 && (
            <Link
              href="/favorites"
              className="md:hidden w-8 h-8 rounded flex items-center justify-center bg-surface-container-low hover:bg-surface-container text-primary-container relative transition-colors"
            ...
            >
              ...
              <span className="absolute -top-0.5 -right-0.5 rtl:-right-auto rtl:-left-0.5 w-4 h-4 rounded-full bg-primary-container text-on-primary-container text-[9px] font-bold flex items-center justify-center">
                {totalFavorites}
              </span>
            </Link>
          )}
      ...
      {isMobileSearchOpen && (
        <div ref={mobileSearchRef} className="md:hidden px-4 py-2 bg-surface-container border-b border-surface-bright/60 relative">
          <div className="relative flex items-center">
            ...
            <input
              ...
              onChange={(e) => handleInputChange(e.target.value)}
              onKeyDown={handleKeyDown}
              className="w-full bg-surface-container-low border border-surface-bright/40 rounded pl-8 pr-8 rtl:pl-8 rtl:pr-8 py-1.5 font-inter text-xs text-on-surface placeholder:text-outline focus:outline-none focus:border-primary transition-colors text-left rtl:text-right"
              placeholder={t('common.search_placeholder', 'Search teams, players, leagues...')}
              type="search"
              aria-label={t('common.search_placeholder', 'Search')}
            />
