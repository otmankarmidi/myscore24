      ...
      <div className="flex-1 max-w-[1440px] w-full mx-auto px-2 md:px-4 py-4 flex gap-4">
        ...
        <main className="flex-1 min-w-0 space-y-3">
          ...
          {isLoading ? (
            ...
            <EmptyState
              title={t('common.noMatchesFound', 'No completed matches found')}
              description={t('common.selectAnotherDate', 'Select another date on the calendar above to view past match results.')}
            />
          ) : (
