        ...
        <main className="flex-1 min-w-0 space-y-3">
          ...
          <div className="flex items-center justify-between bg-surface-container border border-surface-bright/40 rounded-lg p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-on-surface-variant mt-0.5">
                  {t('common.noLiveMatches', 'Real-time live scores and match statistics')}
                </p>
              </div>
            </div>
            <div className="flex items-center gap-3 text-xs font-mono">
              ...
              {lastUpdated && (
                <span className="text-outline hidden sm:inline">{t('common.updated', 'Updated')}: {lastUpdated}</span>
              )}
            </div>
          </div>

          {/* Matches List / Content States */}
          {isLoading ? (
            ...
            <EmptyState
              ...
              description={t('common.noMatchesScheduled', 'Check upcoming fixtures or today\'s full schedule.')}
            />
          ) : (
